## Heading
This Master Development Agreement, is made as of this [N]th day of [MONTH], [YEAR] (the “Effective Date”), by and between, **Party A** (hereinafter referred as “Customer”), existing under the laws of [COUNTRY],and having its registered office at [ADDRESS]. and **Party B** a Company incorporated under the [NAME OF LAW], having its registered office at [ADDRESS], with its principal place of business at [ADDRESS] (“Developer”).
